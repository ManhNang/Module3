      ...
      >
        ...
        <div class="form-group">
          ...
          <div style="display: flex; gap: 15px; margin-top: 5px">
            <label
              ><input type="checkbox" name="permissions" value="1" /> Thêm
              (Add)</label
            >
            <label
              ><input type="checkbox" name="permissions" value="2" /> Sửa
              (Edit)</label
            >
            <label
              ><input type="checkbox" name="permissions" value="3" /> Xoá
              (Delete)</label
            >
            <label
              ><input type="checkbox" name="permissions" value="4" /> Xem
              (View)</label
            >
          </div>
        </div>
